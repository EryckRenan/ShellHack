...
!value = $7B		 ; Address of the value you want to display
...
!BarSize = #$0A		; How many tiles long the bar is (8x8)
!BarTile = #$80		; Base tile for full bar, expects tiles for partial bars to follow
!BarWide    = 0		; Makes a bar two tiles wide/tall
...
!BarProp = #$39		; Properties to use for bar tiles

!BarOverlay = 1		; If 1, draws a static overlay graphic for the bar to fill
!BarOverL = #$90	; The left or top end of the overlay graphic, must be two wide/tall for a wide bar
!BarOverM = #$91	; The middle of the overlay graphic which is repeated to fill length of bar, must be two wide/tall for a wide bar
!BarOverR = #$92	; The right or bottom end of the overlay graphic, must be two wide/tall for a wide bar
