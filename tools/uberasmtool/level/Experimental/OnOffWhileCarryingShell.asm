;===========================================================;
;															;
; Toggle On/Off Switch Values While Carrying Specific Shell	;
; By Cracka													;
;															;
; This toggles the state of the ON/OFF switch, depending on	;
;  whether or not the player is carrying/holding specified	;
;  sprite(s).												;
;															;
...
!CarriedState	= $01				; 01 = Off
!DefaultState	= $00				; 00 = On
...
mouth_check:
	LDA $18E7|!addr					; player holding object flag
	BNE switch_check				; carrying, set carried state
