...
!AllowWhileCarrying = 0                 ; allow change while carrying item. 1 = allow, 0 = do not allow.

main:
        LDA $9D                         ; don't do things when freeze flag is set
        ORA $75                         ; can't perform change underwater

        if !AllowWhileCarrying
        BRA +                           ; ignore running this section to allow changing jump type while carrying item
        endif
