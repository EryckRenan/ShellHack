...
speed:
    dw  $0300, $0000,-$0600 ; 0 this doesn't move at all
    dw  $0300, $0000,-$0600 ; 2 this moves up and smashes down, but hesitates by going down slower before smashing
    dw  $0300, $0000,-$0600 ; 1 this moves up and smashes down without hesitation
    dw  $0300, $0000,-$0600 ; 3 this moves up and smashes down, but hesitates by going back up slower before smashing
    dw  $0300, $0000,-$0600 ; 4 this moves down and smashes up, without hesitation.
    dw  $0300, $0000,-$0600 ; 5
    dw  $0300, $0000,-$0600 ; 6
    dw  $0300, $0000,-$0600 ; 7
    dw  $0300, $0000,-$0600 ; 8
