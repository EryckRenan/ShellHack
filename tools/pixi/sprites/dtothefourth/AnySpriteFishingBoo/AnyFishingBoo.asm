...
;;
;; It has also been remapped to only need one graphics
;; file and a modified SP3=12 bin has been included
;; allowing it bo be used with any SP4.
;;
...
!Sprite = #$0E	; Sprite to spawn with initially
...
;Old tilemap, use this one if you want to use the original GFX11 mapping
