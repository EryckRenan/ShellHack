;=======================================================================================;
;                                                                                       ;
; 1 Bounce Spiny Shell                                                                  ;
;  By Cracka                                                                            ;
;                                                                                       ;
; A spiny koopa shell which can only be spin-jumped onto, & disappears after first      ;
;  interaction.                                                                         ;
;                                                                                       ;
...
;                                                                                       ;
; Extra Bit:                                                                            ;
;  - By default, extra bit is set to spawn the spiny version of the shell.              ;
;                                                                                       ;
;=======================================================================================;
;                                                                                       ;
; No Extra Bytes                                                                        ;
...
!NormalPal      = %00001001 ; Palette C (Red)
!SpinyPal       = %00001001 ; Palette C (Red)
...
; the speed given doesn't depend on if you're holding the jump button or not. Was set to default F8, going to try to emulate spin bounce of spiny
!SpinKillYSpeed     = $F8
...
NormalBounce:
    ...
    ldy !9E,x               ;|
    lda #$28                ;| If set to spawn a new sprite, change its number based on the table.
