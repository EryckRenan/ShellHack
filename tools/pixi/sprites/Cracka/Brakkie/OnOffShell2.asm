...
; changes regular shell palette color depending on the state of on/off switch
!ColorChange        = 1         ; 0 = no color change, 1 = color change

; Palettes of the shells
!ShellPal           = %00001010 ;YXPPCCCT
!SpinyPal           = %00001001
!OnPal              = %00001100 ; Palette E
!OffPal             = %00001110 ; Palette F
...
SetCape:
    ...
    CPY #10
    BNE +
    LDA $14AF|!addr             ; \ Flip the ON/OFF switch status
    EOR #$01                ; |
+   STA $14AF|!addr 
    LDA #!GiveFly
    BEQ .noFly
