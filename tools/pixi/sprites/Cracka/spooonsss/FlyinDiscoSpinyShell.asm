;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;Flying Disco Spiny Shell
;
;This is a disco spiny shell that follows player in air.
;
;By RussianMan. Modified by spooonsss. Modified by Cracka (Spiny Interactions/GFX).
;Credit is optional.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
macro SubHorzPosBnk1()     ;-----------| Subroutine to check horizontal proximity of Mario to a sprite.
...
; uncomment this to synchronize with placeable disco shell
; JML main
RTL
...
%SubHorzPosBnk1()      ; SubHorzPosBnk1 uses $D1 (mario's position current frame) as opposed to pixi's SubHorzPos
TYA
STA !157C,x
...
AND #$03
TAY
LDA WallBumpSpeed-1,y       ;set bumping speed
STA !B6,x
...
STA $02
;LDA Tilemap,y                 ; Changed to custom tiles
    LDA SpinyShellTilemap,y
PLY
STA $0302|!Base2,y

;LDA $02                  ;flip info
;ORA !15F6,x              ;+cfg setting which is useless because we set it afterwards
    LDA #$01                    ; Changed to load spiny gfx
    CLC : ADC !15F6,x
