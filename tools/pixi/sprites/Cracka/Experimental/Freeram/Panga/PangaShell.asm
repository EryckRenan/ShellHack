...
!Freeram			= $7E007C	; Ensure this isn't already used elsewhere in the level

; Palettes of the shells
!NormalPal	= %00000100 ; Palette A
!TargetPal	= %00001010 ; Palette D
...
.NonDisco
	LDA !extra_byte_1,x		; Identifies which shell is being bounced on
	CMP #$01				; If shell 01, jump to .Shell01
	BEQ .Shell01
	CMP #$02
	BEQ .Shell02
	CMP #$03
...
.Shell01					; Shell 01
	LDA !Freeram			; Load bounce count
	BEQ .TargetPal
	CMP #$00				; No interactions
	BEQ .TargetPal			; If 00, set target palette
	CMP #$01				; 01 interaction
	BEQ .TargetPal
	BRA .NormalPal
.Shell02
	LDA !Freeram
