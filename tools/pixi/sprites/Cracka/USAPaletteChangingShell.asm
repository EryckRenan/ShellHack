...
!PaletteA           = %10000010 ; White
!PaletteB           = %00000110 ; Blue
!PaletteC           = %00001000 ; Red
...
SetAction:
    LDA !Freeram,x
    BEQ .SetInitialPalette  ; if clear, set as 0A
    CMP #$0C                
    BEQ .ResetPalette       ; if 0C, set as 0A
    INC #$01                ; increase value by 01
    STA !Freeram,x
    RTS
.SetInitialPalette
    LDA #$0B                ; set as palette 0B, after first interaction
    STA !Freeram,x
    RTS 
.ResetPalette
    LDA #$0A                ; set as palette 0A
    STA !Freeram,x
    RTS
...
.ColorChange
    LDA !Freeram,x
    beq .PalA               ; if clear, set as starting palette 08
    cmp #$0A
    beq .PalA
    cmp #$0B
    beq .PalB
    cmp #$0C
    beq .PalC
    bra .PalA               ; catchall, just to be safe... set as 08
