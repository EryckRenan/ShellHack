...
;   $00 = Displays a blank black box with no message.                                   ;
;   $01 = Displays the values set for message info box 1 for the corresponding level.   ;
;   $02 = Displays the values set for message info box 2 for the corresponding level.   ;                                     ;
;   $03 = Displays the values set for message box "000-2" which is reserved for the     ;
;    first time a player resuces Yoshi in the original game.                			;
;   $0A = Switches between message info box 1 & 2 for the corresponding level.          ;
;                                                                                       ;
;=======================================================================================;
;                                                                                       ;
; Extra byte 2:                                                                         ;
...
SetAction:
    LDA !extra_byte_1,x     ; #$00 = none; #$01 = message 1; #$02 = message 2; #$03 = Yoshi thanks message.
    CMP #$0A
    BEQ +
    BNE ++
+   LDA !Freeram
...
.SetMessage
	LDA !Freeram
++  STA $1426               ; $7E1426, Message box trigger. #$00 = none; #$01 = message 1; #$02 = message 2; #$03 = Yoshi thanks message.
	RTS
