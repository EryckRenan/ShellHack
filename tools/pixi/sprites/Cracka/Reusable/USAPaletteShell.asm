...
!Freeram			= $7E005C	; Ensure this isn't already used elsewhere in the level

; Palettes of the shells (YXPPCCCT)
!White	            = %00000010 ; Palette 9
!Blue               = %00000110 ; Palette B
!Red                = %00001000 ; Palette C
...
SetAction:
    ...
    CMP #$0D                
    BEQ .ResetPalette       ; if 0D, set as 0A
...
.PaletteCheck
    lda !Freeram,x
    beq .Pal1               ; if clear, set as starting value of #$0A
    cmp #$0A
    beq .Pal1
    cmp #$0B
    beq .Pal2
    ...
    cmp #$0D
    beq .Pal4
    bra .Pal1               ; catchall, just to be safe... set value to #$0A
