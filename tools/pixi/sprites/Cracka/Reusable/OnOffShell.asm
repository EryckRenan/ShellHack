...
;                                                                                       ;
; Note: If using !ColorChange (to change palette from default/vanilla settings), don't  ;
;  forget to update the palettes E & F with the included .pal                          ;
;                                                                                       ;
;=======================================================================================;
;                                                                                       ;
...
; Changes regular shell palette color depending on the current player number
!ColorChange        = 1         ; 0 = no color change, 1 = color change

; Palettes of the shells
!ShellPal           = %00001010 ;YXPPCCCT
!OnPal              = %00001110 ; Palette F
!OffPal             = %00000110 ; Palette B
...
SetAction:
    LDA !extra_byte_1,x     ; $7E14AF, #$00 = ON, all other values is OFF
    CPY #10
    BNE +
    LDA $14AF|!addr
    EOR #$01                ; Flip the ON/OFF switch status
+   STA $14AF|!addr 
    RTS
