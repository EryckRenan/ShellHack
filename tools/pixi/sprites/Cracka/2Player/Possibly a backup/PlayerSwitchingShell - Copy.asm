...
; v1.0, by KevinM                                                                       ;
; Interaction Behaviors & Palette Updates by Cracka                                     ;
;=======================================================================================;
...
;   $00 = Changes current player to player 1 only.                                      ;
;   $01 = Changes current player to player 2 only.                                      ;
;   $0A = Switches current player to opposite player.                                   ;
;                                                                                       ;
; Note that if $00 or $01 are used that onced switched to the other player, the shells  ;
...
!ShellPal           = %00000100 ;YXPPCCCT
!SpinyPal           = %00001001
!MarioPal           = %00001000 ; Palette C
!LuigiPal           = %00001010 ; Palette D
!Palette8           = %00000000 ; Palette 8
!Palette9           = %00000010 ; Palette 9
!PaletteA           = %00000100 ; Palette A
!PaletteB           = %00000110 ; Palette B
!PaletteC           = %00001000 ; Palette C
!PaletteD           = %00001010 ; Palette D
...
; Original settings for KevinM's extra_byte_1 koopa variables are now set here, because Cracka repurposed extra_byte_1 to determine the shell action type.
;=======================================================================================;
