...
SetAction:
    LDA !extra_byte_1,x     ; should the palette switch?
    CMP #10                 ; if yes, change if not, skip
    BNE +
    LDA $0DB3               ; set the player character (00:mario,01:luigi)
    EOR #$01
+   STA $0DB3               ; |!addr
    RTS
...
.ChangePal
    lda $0DB3|!addr         ; check mario/luigi
    beq .LuigiPal
.MarioPal
    lda #!MarioPal
    bra .DiscoPal
