...
;Tilemap defines:
!Propeller1 =	$E8	;propeller frame 1
!Propeller2 =	$E9	;propeller frame 2
!Propeller3 =	$F8	;propeller frame 3
!Propeller4 =	$F9	;propeller frame 4
!Body =		$E4	;body
!Feet =		$EA	;feet
...
!SpawnTile =	$24	;16x16 tile to use for the carried sprite. Now it's set to mushroom.
!SpawnProp =	$08	;tile properties for carried sprite, YXPPCCCT format. Now it uses palette C. 

;Reminder: Y - Y flip; X - X flip; PP - priority from 1 to 4(0 to 3); CCC - palette(000 - palette 8, 001 - palette 9, 010 - palette A, 011 - palette B, 100 - palette C, 101 - palette D, 110 - palette E, 111 - palette F); T - GFX page. Generally 0 - disable, 1 - enable.
...
Run:
	...
	LDA !C2,x
	BNE Return		;don't generate if already done
