; Spawn Carried Multi-Bounce Shell With 1 Bounce
...
!bounce_count    = $01          ; Number of bounces (01-09 = 1-9 bounces, 0A = infinite bounces)
...
print "This block spawns a 1 bounce shell that is automatically carried and destroys itself afterwards."
