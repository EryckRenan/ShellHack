; Spawn Carried Multi-Bounce Shell With 8 Bounces
...
!bounce_count    = $08          ; Number of bounces (01-09 = 1-9 bounces, 0A = infinite bounces)
...
print "This block spawns a 8 bounce shell that is automatically carried and destroys itself afterwards."
