; Spawn Carried Sprite (While Carrying Item)
; Modified by Cracka
...
!Disco			= 0				; 0 = No, 1 = Yes
!Ghost			= 1				; 0 = No, 1 = Yes. If Carry = 1, Set As 1

; Conditions - Don't Run Code If...
!Carry			= 1				; Player Is Carrying Something. 0 = Don't Allow, 1 = Allow
!Yoshi			= 1				; Player Is Riding Yoshi. 0 = Don't Allow, 1 = Allow
...
print "This block spawns a carried sprite even if player is already carrying something. The block destroys itself afterwards."