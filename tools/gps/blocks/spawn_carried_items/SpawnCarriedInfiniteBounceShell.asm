; Spawn Carried Multi-Bounce Shell With infinite Bounces
...
!bounce_count    = $0A          ; Number of bounces (01-09 = 1-9 bounces, 0A = infinite bounces)
...
print "This block spawns an infinite bounce shell that is automatically carried and destroys itself afterwards."
