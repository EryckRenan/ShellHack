; Spawn Carryable Multi-Bounce Shell
...
!bounce_count    = $00          ; Extension byte 1: number of bounces (01 = one bounce)
...
print "This block spawns a one-time usable multi-bounce shell that is automatically carried and destroys itself afterwards."
