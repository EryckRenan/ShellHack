; Spawn Carried Disco Shell (While Riding Yoshi)
; Modified by Cracka
...
; Sprite Properties
!ActAsSprite	= $08			; $04 = Green, $05 = Red, $06 = Blue, $07 = Yellow
!Custom			= 1				; 0 = Vanilla, 1 = Custom
...
print "This block spawns a carried disco shell while riding Yoshi. The block destroys itself afterwards."