; Spawn Carried Yellow Shell (While Riding Yoshi)
; Modified by Cracka
...
; Sprite Properties
!ActAsSprite	= $07			; $04 = Green, $05 = Red, $06 = Blue, $07 = Yellow
...
print "This block spawns a carried yellow shell while riding Yoshi. The block destroys itself afterwards."