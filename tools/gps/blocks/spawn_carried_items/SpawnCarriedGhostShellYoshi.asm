; Spawn Carried Ghost Shell (While Riding Yoshi)
; Modified by Cracka
...
print "This block spawns a carried ghost shell while riding Yoshi. The block destroys itself afterwards."