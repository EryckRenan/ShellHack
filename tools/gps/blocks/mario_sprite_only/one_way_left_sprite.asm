...
db $37
JMP return : JMP return : JMP return : JMP return : JMP SpriteH : JMP return
JMP return : JMP return : JMP return : JMP return : JMP return : JMP return
...
print "Solid to sprites moving rightwards."